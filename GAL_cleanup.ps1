<#
    .SYNOPSIS 
        This script looks for accounts in AD that ane disabled, then checkes Exchange to see if the account is still visable.
        If you'd like to remove the user from the GAL uncomment line 15
